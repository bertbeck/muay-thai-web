 ...
 --------------------------------------------------------------*/
  ...
  function modalVideo() {
    $(document).on("click", ".ak-video-open", function (e) {
        ...
        // Get video URL from the "data-video" attribute
        var videoSrc = $(this).attr("data-video");

        // Set the video source
        var videoElement = $(".ak-popup-video");
        videoElement.find("source").attr("src", videoSrc);
        videoElement[0].load(); // Reload video source
        videoElement[0].play(); // Autoplay video
    ...
    $(".ak-video-popup-close, .ak-video-popup-layer").on("click", function (e) {
        ...
        var videoElement = $(".ak-popup-video")[0];
        videoElement.pause(); // Pause video when popup closes
